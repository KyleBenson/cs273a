...
\item \vspace{-1in}\includegraphics[width=.45\textwidth]{\figdir/prob1a.pdf}
...
\begin{tabular}[c]{cc}
%\vspace{-1in}
\includegraphics[width=.45\textwidth]{\figdir/prob1b_5.pdf}
\includegraphics[width=.45\textwidth]{\figdir/prob1b_20.pdf}
\end{tabular}
\end{figure}
...
complete  &\includegraphics[width=.45\textwidth]{\figdir/prob1c_max_20.pdf} & \includegraphics[width=.45\textwidth]{\figdir/prob1c_max_5.pdf}
\\

single &
\includegraphics[width=.45\textwidth]{\figdir/prob1c_min_20.pdf} &
\includegraphics[width=.45\textwidth]{\figdir/prob1c_min_5.pdf}
\end{tabular}
\end{figure}
...
\begin{tabular}{cc}
$k=5$ & $k=20$ \\
\includegraphics[width=.45\textwidth]{\figdir/prob1d_5.pdf} &
\includegraphics[width=.45\textwidth]{\figdir/prob1d_20.pdf}
\end{tabular}
\end{figure}
...
\item MSE for $K=1...10$
\includegraphics[width=.45\textwidth]{\figdir/prob3c.pdf}

\item First 5 principle directions (minus in first row):
\begin{figure}[h!] \centering
\begin{tabular}{ccccc}
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_minus1.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_minus2.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_minus3.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_minus4.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_minus5.pdf} \\
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_plus1.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_plus2.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_plus3.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_plus4.pdf} &
\hspace{-.5in}\includegraphics[width=.25\textwidth]{\figdir/prob3d_plus5.pdf} \\
\end{tabular}
\end{figure}
...
\includegraphics[width=.45\textwidth]{\figdir/prob3e.pdf}
...
face 42 & \includegraphics[width=.25\textwidth]{\figdir/prob3f_face42_K5.pdf} &
\includegraphics[width=.25\textwidth]{\figdir/prob3f_face42_K10.pdf} &
\includegraphics[width=.25\textwidth]{\figdir/prob3f_face42_K50.pdf} \\

face 620 &
\includegraphics[width=.25\textwidth]{\figdir/prob3f_face620_K5.pdf} &
\includegraphics[width=.25\textwidth]{\figdir/prob3f_face620_K10.pdf} &
\includegraphics[width=.25\textwidth]{\figdir/prob3f_face620_K50.pdf} \\
\end{tabular}
\end{figure}
